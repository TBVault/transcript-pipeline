#!/usr/bin/env bash
# test_pipeline_15.sh — End-to-end pipeline on 10 test MP3 files
# typing.Any added to torch safe_globals (PyTorch 2.6 pyannote VAD fix).
...
echo "=== test_pipeline_15 on $(hostname) at $(date) ==="
cd "$REPO_DIR"
